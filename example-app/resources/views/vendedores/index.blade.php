                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            {{-- Eliminar Admin --}}
                     <form action="{{ route('vendedores.destroy', $usuario->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este administrador? Esta acción no se puede deshacer.');">
                            @csrf
                            @method('DELETE')
                            ...
                            @if(!$usuario->persona || !$usuario->persona->vendedor)
                                <a href="{{ route('vendedores.create', ['user_id' => $usuario->id]) }}" class="btn btn-success btn-sm ml-1">
