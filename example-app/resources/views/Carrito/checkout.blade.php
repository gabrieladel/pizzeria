                        ...
                        <form action="{{ route('cart.process') }}" method="POST" id="checkout-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="telefono" placeholder="Ej: 12345678"
                                        required>
                                </div>
                            ...
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle"></i> Al hacer clic en "Finalizar", tu pedido se guardará en tu
                                historial personal.
                            </div>
