...
@section('contenido')
        ...
        <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://images.unsplash.com/photo-1584859977999-531c305575b7" class="d-block w-100"
                        height="400">
    ...
    <section id="video">
        ...
        <div class="text-center">
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/ywrLSeDVH5U" allowfullscreen>
            </iframe>
        </div>
    </section>
@endsection
