...
@section('content')
    ...
    <div class="d-flex align-content-stretch flex-wrap" style="text-align: center;">
        <div class="p-5 table-responsive">
            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalRegistrar">Añadir producto</button>
                ...
                <tbody>
                    @foreach ($listado as $item)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('productos-admin.destroy', $item->id) }}" method="POST"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('productos-admin.update', $item->id) }}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1" class="form-label">id del
                                                        producto</label>
                                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                                        aria-describedby="txtHelp" name="txtid"
                                                        value="{{ $item->id }}">
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail2"
                                                        aria-describedby="txtHelp" name="txtnombre"
                                                        value="{{ $item->nombre }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">Categoría del producto</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="exampleInputEmail1" class="form-label">Imagen del
                                                        producto</label>
                                                    <input type="text" class="form-control" id="exampleInputEmail4"
                                                        aria-describedby="txtHelp" name="txtimagen"
                                                        value="{{ $item->imagen }}">
                                                </div>
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail5"
                                                        aria-describedby="txtHelp" name="txtdescripcion"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="exampleInputEmail6"
                                                        aria-describedby="txtHelp" name="txtprecio"
                                                        value="{{ $item->precio }}">
                                                </div>
